  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 p-6 flex justify-between items-center">
        <div className="text-white text-3xl font-bold">chợTỐT</div>
        <div className="flex gap-6 text-white font-semibold">
          <a href="#" className="hover:underline">Tôi là người bán</a>
          <a href="#" className="hover:underline">Tôi là người mua</a>
        </div>
        <input
          type="text"
