  ...
  return (
    <div className="space-y-8">
              ...
              <CardContent>
                  ...
                  {deviceData.map((device) => (
                    <div key={device.device} className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium text-slate-900 dark:text-slate-100">{device.device}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium w-8 text-slate-900 dark:text-slate-100">{device.users}%</span>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-6 grid grid-cols-3 gap-4 text-center">
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    ...
                    <div className="text-sm font-medium text-blue-900 dark:text-blue-100">Desktop</div>
                    <div className="text-xs text-blue-600 dark:text-blue-400">45% Users</div>
                  </div>
                  <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                    <Smartphone className="h-6 w-6 mx-auto mb-2 text-purple-600 dark:text-purple-400" />
                    <div className="text-sm font-medium text-purple-900 dark:text-purple-100">Mobile</div>
                    <div className="text-xs text-purple-600 dark:text-purple-400">35% Users</div>
                  </div>
                  <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <Globe className="h-6 w-6 mx-auto mb-2 text-green-600 dark:text-green-400" />
                    <div className="text-sm font-medium text-green-900 dark:text-green-100">Tablet</div>
                    <div className="text-xs text-green-600 dark:text-green-400">20% Users</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-4">
                  {trafficSources.map((source, index) => (
                    <div key={source.source} className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
                      <div className="flex items-center gap-3">
                        <div className={`w-3 h-3 rounded-full bg-${['blue', 'purple', 'green', 'yellow', 'red'][index]}-500`} />
                        <span className="font-medium text-slate-900 dark:text-slate-100">{source.source}</span>
                      </div>
                      <div className="text-right">
                        <div className="font-semibold text-slate-900 dark:text-slate-100">{source.visits.toLocaleString()}</div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card className="border-0 shadow-lg bg-white dark:bg-slate-800">
              ...
              <CardContent>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Active users right now</p>
            ...
            <Card className="border-0 shadow-lg bg-white dark:bg-slate-800">
              ...
              <CardContent>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">From all visitors</p>
                <div className="mt-4">
                  <div className="flex items-center gap-2">
            ...
            <Card className="border-0 shadow-lg bg-white dark:bg-slate-800">
              ...
              <CardContent>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Per transaction</p>
                <div className="mt-4">
                  <div className="flex items-center gap-2">
                    <ArrowUpRight className="h-4 w-4 text-green-500" />
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
        {/* Recent Orders */}
        <Card className="col-span-full lg:col-span-4 border-0 shadow-lg bg-white dark:bg-slate-800">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-slate-900 dark:text-slate-100">
              <div className="p-2 bg-gradient-to-r from-purple-500 to-pink-600 rounded-lg">
          ...
          <CardContent>
            <div className="space-y-4">
              {recentOrders.map((order) => (
                <div key={order.id} className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
        ...
        {/* Quick Stats */}
        <Card className="col-span-full lg:col-span-3 border-0 shadow-lg bg-white dark:bg-slate-800">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-slate-900 dark:text-slate-100">
              <div className="p-2 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg">
                <TrendingUp className="h-4 w-4 text-white" />
          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                <span className="text-slate-900 dark:text-slate-100">Sales Goal</span>
                <span className="text-slate-600 dark:text-slate-400">$12,000 / $15,000</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-slate-600 dark:text-slate-400">4.8/5.0</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-slate-600 dark:text-slate-400">4.6/5.0</span>
              </div>
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-slate-700">
              <div className="flex items-center justify-between text-sm mb-2">
                <span className="font-medium text-slate-900 dark:text-slate-100">Top Product Category</span>
              </div>
              <div className="text-2xl font-bold text-slate-900 dark:text-slate-100">Electronics</div>
